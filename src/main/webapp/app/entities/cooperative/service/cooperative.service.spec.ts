...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../cooperative.test-samples';

import { CooperativeService } from './cooperative.service';

const requireRestSample: ICooperative = {
...
describe('Cooperative Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Cooperative', () => {
      ...
      const cooperative = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(cooperative).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Cooperative', () => {
      const cooperative = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(cooperative).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addCooperativeToCollectionIfMissing', () => {
      it('should add a Cooperative to an empty array', () => {
        const cooperative: ICooperative = sampleWithRequiredData;
      ...
      it("should add a Cooperative to an array that doesn't contain it", () => {
        const cooperative: ICooperative = sampleWithRequiredData;
        const cooperativeCollection: ICooperative[] = [sampleWithPartialData];
        expectedResult = service.addCooperativeToCollectionIfMissing(cooperativeCollection, cooperative);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(cooperative);
      });
      ...
      it('should add only unique Cooperative to an array', () => {
        const cooperativeArray: ICooperative[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const cooperativeCollection: ICooperative[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const cooperative: ICooperative = sampleWithRequiredData;
        const cooperative2: ICooperative = sampleWithPartialData;
    ...
    describe('compareCooperative', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareCooperative(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareCooperative(entity1, entity2);
        const compareResult2 = service.compareCooperative(entity2, entity1);
