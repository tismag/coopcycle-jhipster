...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("coopcycle.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("coopcycle.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
